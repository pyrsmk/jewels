...
export class TemporalGhostEffect extends EffectInterface {
  ...
  transform({ gl, locs }) {
    gl.uniform1f(locs.u_temporalGhost,
      this.options.temporalGhostEnabled ? +(this.options.temporalGhost ?? 0.20) : 0.0);
