...
${chunks.post}
  ...
  _buildPostLocs(prog) {
    ...
    return {
      ...
      u_colorTint2: gl.getUniformLocation(prog, 'u_colorTint2'),
      u_colorTint2Palette: gl.getUniformLocation(prog, 'u_colorTint2Palette'),
      u_colorTint2Speed: gl.getUniformLocation(prog, 'u_colorTint2Speed'),
      u_colorTint2Scale: gl.getUniformLocation(prog, 'u_colorTint2Scale'),
      ...
      u_hGlitch: gl.getUniformLocation(prog, 'u_hGlitch'),
      u_hGlitchSpeed: gl.getUniformLocation(prog, 'u_hGlitchSpeed'),
      u_hGlitchScale: gl.getUniformLocation(prog, 'u_hGlitchScale'),
      u_hGlitchThreshold: gl.getUniformLocation(prog, 'u_hGlitchThreshold'),
